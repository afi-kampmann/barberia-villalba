        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="relative group overflow-hidden border border-white/10 aspect-[3/4] bg-zinc-900">
              <img 
                src="/gallery-3.webp" 
                alt="Corte degradado con barba - Barbería Villalba" 
                className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                <div>
                  <p className="text-xs tracking-[0.2em] text-white/60 uppercase font-bold mb-1">Corte Premium</p>
                  <p className="text-sm font-bold">Degradado Profesional</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative group overflow-hidden border border-white/10 aspect-[3/4] bg-zinc-900">
              <img 
                src="/gallery-4.webp" 
                alt="Corte texturizado moderno - Barbería Villalba" 
                className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                <div>
                  <p className="text-xs tracking-[0.2em] text-white/60 uppercase font-bold mb-1">Corte Moderno</p>
                  <p className="text-sm font-bold">Textura Contemporánea</p>
                </div>
              </div>
            </div>
